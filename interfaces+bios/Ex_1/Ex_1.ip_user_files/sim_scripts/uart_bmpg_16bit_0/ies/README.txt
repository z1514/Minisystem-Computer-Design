...
#
# Generated by export_simulation on Tue Dec 03 17:06:28 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './uart_bmpg_16bit_0.sh' script.

./uart_bmpg_16bit_0.sh -reset_run
...
./uart_bmpg_16bit_0.sh -noclean_files

For more information on the script, please type './uart_bmpg_16bit_0.sh -help'.
