...
HD_PWD='C:/Users/yuanyuan/Ex_1/Ex_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log S86SoC.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source S86SoC.tcl
