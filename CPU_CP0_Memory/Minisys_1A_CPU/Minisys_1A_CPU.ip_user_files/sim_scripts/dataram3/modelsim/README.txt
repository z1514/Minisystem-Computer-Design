...
#
# Generated by export_simulation on Sat Jan 16 13:31:11 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './dataram3.sh' script.

./dataram3.sh -reset_run
...
./dataram3.sh -noclean_files

For more information on the script, please type './dataram3.sh -help'.
