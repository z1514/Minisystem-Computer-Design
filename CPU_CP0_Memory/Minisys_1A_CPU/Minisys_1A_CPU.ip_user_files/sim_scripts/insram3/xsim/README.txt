...
#
# Generated by export_simulation on Sat Jan 16 13:32:00 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './insram3.sh' script.

./insram3.sh -reset_run
...
./insram3.sh -noclean_files

For more information on the script, please type './insram3.sh -help'.
