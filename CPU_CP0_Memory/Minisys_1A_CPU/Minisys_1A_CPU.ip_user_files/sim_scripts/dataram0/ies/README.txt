...
#
# Generated by export_simulation on Sat Jan 16 13:31:47 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './dataram0.sh' script.

./dataram0.sh -reset_run
...
./dataram0.sh -noclean_files

For more information on the script, please type './dataram0.sh -help'.
