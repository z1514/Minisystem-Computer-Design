...
#
# Generated by export_simulation on Sat Jan 16 13:32:11 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './insram2.sh' script.

./insram2.sh -reset_run
...
./insram2.sh -noclean_files

For more information on the script, please type './insram2.sh -help'.
