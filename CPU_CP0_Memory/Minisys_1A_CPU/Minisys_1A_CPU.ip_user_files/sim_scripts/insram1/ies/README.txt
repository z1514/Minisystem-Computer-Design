...
#
# Generated by export_simulation on Sat Jan 16 13:32:21 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './insram1.sh' script.

./insram1.sh -reset_run
...
./insram1.sh -noclean_files

For more information on the script, please type './insram1.sh -help'.
