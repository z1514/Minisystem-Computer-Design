...
#
# Generated by export_simulation on Thu Jan 14 19:52:36 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './instruction_memory_1.sh' script.

./instruction_memory_1.sh -reset_run
...
./instruction_memory_1.sh -noclean_files

For more information on the script, please type './instruction_memory_1.sh -help'.
