...
#
# Generated by export_simulation on Sat Jan 16 13:32:31 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './insram0.sh' script.

./insram0.sh -reset_run
...
./insram0.sh -noclean_files

For more information on the script, please type './insram0.sh -help'.
