...
#
# Generated by export_simulation on Sat Jan 16 13:31:37 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './dataram1.sh' script.

./dataram1.sh -reset_run
...
./dataram1.sh -noclean_files

For more information on the script, please type './dataram1.sh -help'.
