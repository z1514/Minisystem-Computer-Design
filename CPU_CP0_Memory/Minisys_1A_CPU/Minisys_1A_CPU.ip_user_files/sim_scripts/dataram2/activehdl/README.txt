...
#
# Generated by export_simulation on Sat Jan 16 13:31:25 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './dataram2.sh' script.

./dataram2.sh -reset_run
...
./dataram2.sh -noclean_files

For more information on the script, please type './dataram2.sh -help'.
